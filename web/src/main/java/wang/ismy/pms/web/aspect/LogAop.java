package wang.ismy.pms.web.aspect;
...
import wang.ismy.pms.web.controller.SysLogController;
...
// 主要获取访问时间、访问的类、访问的方法
    ...
    @Before("execution(* wang.ismy.pms.web.controller.*.*(..))")
...
// 有参数，就将args中所有元素遍历，获取对应的Class,装入到一个Class[]
    ...
    @After("execution(* wang.ismy.pms.web.controller.*.*(..))")
